        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>Small Scale Industry blogs</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="blog-details__left">
                            <div class="blog-details__img">
                                <img src="assets/images/blog/blog-image-2.jpg" alt="">
                            ...
                            <div class="blog-details__content">
                                ...
                                <h3 class="blog-details__title">Small Scale Industry/Home Industry</h3>
                                <p class="blog-details__text-2">
                                    <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                    Home industry means the manufacturing of goods at home by hands with small capital an a small scale by some members.
